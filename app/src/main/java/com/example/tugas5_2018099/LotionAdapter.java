...
public class LotionAdapter extends RecyclerView.Adapter<LotionAdapter.LotionViewHolder> {
   ...
   String data1[], data2[], data3[];
    ...
    @NonNull
    @Override
    public LotionAdapter.LotionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LotionAdapter.LotionViewHolder holder, int position) {
